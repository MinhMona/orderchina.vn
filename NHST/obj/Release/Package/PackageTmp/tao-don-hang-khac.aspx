                                                                ...
                                                                <tr class="slide-up product-item">
                                                                    <td>
                                                                        <div>
                                                                            ...
                                                                            <a href="javascript:;" class="remove" style="display: none"><i class="material-icons">delete</i></a>
                                                                        </div>
                                                                    ...
                                                                    <td class="no-wrap">
                                                                        <!-- Dropdown Trigger -->
                                                                        <a href='javascript:;' class="remove-product"><i class="material-icons valign-center">delete</i></a>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.create-product .add-product').on('click', function () {
                ...
                html += ' <a href="javascript:;" class="remove" style="display: none"><i class="material-icons">delete</i></a> ';
                html += ' </div> ';
                ...
                html += '<a href="javascript:;" class="remove-product"><i class="material-icons valign-center">delete</i></a> ';
                html += ' </td>';
                html += ' </tr>';
