<%@ Page Title="Xuất file hàng mua hộ" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="Report_General.aspx.cs" Inherits="NHST.manager.Report_General" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Xuất file đơn hàng mua hộ</h4>
    ...
    <script>
        ...
        function CheckBarcode(IDBarcode) {
            $.ajax({
                type: "POST",
                url: "/manager/Report_General.aspx/CheckBarcode",
