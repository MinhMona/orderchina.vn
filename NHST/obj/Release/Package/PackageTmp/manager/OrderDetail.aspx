...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <div class="child-fee">
                                    ...
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                         ...
                                         <div class="order-row" style="display:none">
                                            <div class="left-fixed">
                                                <p class="txt">Tổng thể tích</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="txtOrderVolume" placeholder="0" type="text" value=""></asp:TextBox>
                                                        <label>m3</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order-row" style="display:none">
                                            <div class="left-fixed">
                                                <p class="txt">
                                                    Phí vận chuyển thể tích (CK
                                                    <asp:Label ID="lblCKFeeVolume" runat="server"></asp:Label>%: 
                                                        <asp:Label ID="lblCKFeeVolumePrice" runat="server"></asp:Label>)
                                                </p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="pVolumeNDT" placeholder="0" type="text" value=""></asp:TextBox>
                                                        <label>Thể tích (m3)</label>
                                                    </div>
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="pVolume" placeholder="0" type="text" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <asp:HiddenField ID="hdfFeeVolumeDiscount" runat="server" />
    <asp:HiddenField ID="hdfFeeweightPriceDiscount" runat="server" />
    <asp:HiddenField ID="hdfFeeVolumePriceDiscount" runat="server" />
        ...
        <script>
                    ...
                    success: function (msg) {
                        ...
                        if (data != null) {
                            if (data != id) {
                                ...
                                html += "</span>";
                                html += "</div>";
                                html += "<a href='javascript:;' style=\"line-height:80px;position:absolute\" class=\"remove-order tooltipped\" data-position=\"top\" data-tooltip=\"Xóa\"><i class=\"material-icons\">delete</i></a>";
                                html += "</div>";
                        ...
                        success: function (msg) {
                            ...
                            if (data != null) {
                                if (data != id) {
                                    ...
                                    html += "</span>";
                                    html += "</div>";
                                    html += "<a href='javascript:;' onclick=\"deleteMVD($(this))\" style=\"line-height:80px;position:absolute\" class=\"remove-order\"><i class=\"material-icons\">delete</i></a>";
                                    html += "</div>";
                                    tableHTML.append(html);
                                    obj.val("");
                                    $("#<%=ddlMainOrderCode.ClientID%>").append('<option value="' + data + '" selected>' + MainOrderCode + '</option>');
            ...
            $(document).ready(function () {
                ...
                $('.mvc-list .add-product').on('click', function () {
                   ...
                   <%-- var transactionCodeMainOrderCodeHTML = $("#<%=ddlMainOrderCode.ClientID%>").html().replace('selected', '');--%>
                    ...
                    html += `<td>
                              ...
                              <td class="">
                              <!-- Dropdown Trigger -->
                              <a href='javascript:;' onclick="deleteOrderCode($(this))" class=\"tooltipped\" data-position=\"top\" data-tooltip=\"Xóa\"><i class="material-icons valign-center">delete</i></a>
                ...
                $('.fsupport-list .add-product').on('click', function () {
                    ...
                    html += `                              <td class="">
                              <!-- Dropdown Trigger -->
                              <a href='javascript:;' onclick="deleteSupportFee($(this))" class=\"tooltipped\" data-position=\"top\" data-tooltip=\"Xóa\"><i class="material-icons valign-center">delete</i></a>
