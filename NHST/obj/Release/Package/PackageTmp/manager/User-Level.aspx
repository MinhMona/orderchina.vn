                    ...
                    <table class="table bordered centered highlight  ">
                        <thead>
                            <tr>
                                ...
                                <th class="tb-date">Chiếc khấu phí cân nặng</th>
                                <th class="tb-date">Chiếc khấu phí thể tích</th>
    ...
    <div class="modal-bd">
        <div class="row">
            ...
            <div class="input-field col s12">
                ...
                <label for="edit_type">Chiết khấu phí cân nặng</label>
            </div>
            <div class="input-field col s12">
                <asp:TextBox runat="server" id="txtFeeVolume" type="text" class="validate" data-type="text-only" value="0"></asp:TextBox>
                <label for="edit_type">Chiết khấu phí thể tích</label>
            </div>
            <div class="input-field col s12">
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=txtFeeVolume.ClientID%>').val(data.FeeVolume);
