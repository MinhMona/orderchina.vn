            ...
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    <div class="filter">
                        ...
                        <%--  <div class="search-name input-field no-margin" style="font-weight: 600; padding-bottom: 5px" id="findcode">
                            Mã vận đơn <span class="notexist">123123123</span> chưa tồn tại, vui lòng kiểm tra <a href="/manager/Order-Transaction-Code" target="_blank" style="font-weight: bold">tại đây</a>.
                        </div>--%>
        ...
        function printBarcode(barcode) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
                    html += "           <label class=\"row-name\" style=\"width:50%\">Tên: </label>";
                    html += "           <label class=\"row-info\">" + data.Fullname + "</label>";
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
                    html += "           <label class=\"row-name\" style=\"width:50%\">Địa chỉ: </label>";
                    html += "           <label class=\"row-info\">" + data.Address + "</label>";
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
                    html += "           <label class=\"row-name\" style=\"width:50%\">Email: </label>";
                    html += "           <label class=\"row-info\">" + data.Email + "</label>";
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
