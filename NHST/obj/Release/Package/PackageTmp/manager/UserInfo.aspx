                ...
                <div class="rp-detail card-panel row">
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <div class="input-field col s12 m6">
                                <asp:TextBox runat="server" ID="txtIDCustomer" placeholder="" MaxLength="15" type="text"></asp:TextBox>
                        ...
                        <asp:Panel ID="pnAdmin" runat="server" Visible="true">
                            <div class="row border-bottom-1">
                                ...
                                <div class="input-field col s12 m6">
                                    ...
                                    <label for="rp_email">Phí mua hàng riêng CK(%)</label>
                                </div>
                                <div class="input-field col s12 m6">
                                ...
                                <div class="input-field col s12 m6">
                                    <asp:TextBox placeholder="" runat="server" ID="txtFeeVolume" TextMode="Number"></asp:TextBox>
                                    <label for="rp_phone">Phí cân thể tích riêng (VND/m3)</label>
                                </div>
                                <div class="input-field col s12 m6" style="display: none">
                        ...
                        <asp:Panel runat="server" ID="pnWareHouseTQ" Visible="true">
                            <div class="row border-bottom-1">
                                <div class="input-field col s12 m6">
...
<%--                        <asp:Panel runat="server" ID="pnWareHouseVN" Visible="true">
                            <div class="row border-bottom-1">
                                <div class="input-field col s12 m6">
                                    <asp:DropDownList ID="ddlWareHouseVN" runat="server" AppendDataBoundItems="true"
                                        DataTextField="WareHouseName" DataValueField="ID">
