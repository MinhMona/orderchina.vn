                        ...
                        <div class="row">
                           ...
                           <div class="input-field col s12 m4">
                            ...
                            <asp:HiddenField runat="server" ID="hdfSideBar" Value="0" />
                             <div class="input-field col s12 m4">
                                <asp:TextBox runat="server" ID="txtIndexPos" type="number" class="validate" data-type="number-only"></asp:TextBox>
                                <label for="add_indexpos">Vị trí sắp xếp</label>
                            </div>        
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            tinymce.init({
                ...
                menubar: false,
                oninit: "setPlainText",
                plugins: "paste imagetools link",
                paste_as_text: true,
                inline: false,
                menubar: 'file edit insert view format table tools help imagetools',
                toolbar: 'formatselect | bold italic strikethrough forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | table UploadImage link media | removeformat | link',
                content_css: [
