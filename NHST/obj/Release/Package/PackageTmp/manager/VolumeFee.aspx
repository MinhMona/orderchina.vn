<%@ Page Language="C#" Title="Cấu hình phí thể tích" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="VolumeFee.aspx.cs" Inherits="NHST.manager.VolumeFee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    <asp:ListBox runat="server" name="method" ID="lbEditShippingName">
                        <asp:ListItem Value="1">TMĐT</asp:ListItem>                     
                    </asp:ListBox>
    ...
    <script>
        function EditFunction(ID) {
            $.ajax({
                type: "POST",
                url: "/manager/VolumeFee.aspx/loadinfo",
                data: '{ID: "' + ID + '"}',
