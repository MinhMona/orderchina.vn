    ...
    public partial class quen_mat_khau2 : System.Web.UI.Page
    {
        ...
        protected void btngetpass_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                if (tk != null)
                {
                    string link = "<a href=\"http://localhost:64544/mat-khau-moi.aspx?token=" + token + "\">đây</a>";
                    try
                    {
                        PJUtils.SendMailGmail("no-reply@mona-media.com", "demonhunter", txtEmail.Text.Trim(),
                            "Reset Mật khẩu trên Taobao.vn",
