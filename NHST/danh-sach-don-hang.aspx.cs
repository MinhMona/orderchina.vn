                ...
                if (total > 0)
                {
                    ...
                    for (int i = 0; i < acs.Count; i++)
                    {
                        ...
                        else if (status == 7)
                        {
                            ...
                            {
                                //var yc = YCGController.GetByMainOrderID(item.ID);
                                //if (yc == null)
                                //{
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGmail("no-reply@mona-media.com", "demonhunter", admin.Email,
                                                            "Thông báo tại Taobao.vn.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                    ...
                    if (lmain.Count > 0)
                    {
                        foreach (var o in lmain)
                        {
                            ...
                            if (user != null)
                            {
                                ...
                                double userdadeposit = Convert.ToDouble(user.Wallet);
                                double feewarehouse = 0;
                                            ...
                                            if (setNoti != null)
                                            {
                                                if (setNoti.IsSentNotiAdmin == true)
                                                {
                                                    ...
                                                    if (admins.Count > 0)
                                                    {
                                                        foreach (var admin in admins)
                                                        {
                                                            NotificationsController.Inser(admin.ID, admin.Username, o.ID, "Đơn hàng " + o.ID + " đã được thanh toán.", 1, currentDate, obj_user.Username, false);
                                                        }
                                                    }
                                                ...
                                                if (setNoti.IsSentEmailAdmin == true)
                                                {
                                                    ...
                                                    if (admins.Count > 0)
                                                    {
                                                        foreach (var admin in admins)
                                                        {
                                                            ...
                                                            {
                                                                PJUtils.SendMailGmail("no-reply@mona-media.com", "demonhunter", admin.Email,
                                                                    "Thông báo tại Minh An Express.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                                            }
                                                            catch { }
                                                        }
                                                    }
