        ...
        public void loadData()
        {
            try
            {
                ...
                if (pt != null)
                {
                    ...
                    ltrTitle.Text = "<h2 class=\"main-title2 main-title-2\">" + pagetypename + "</h2>";
                    ...
                    string weblink = "https://taobao.vn";
                    ...
                    if (!string.IsNullOrEmpty(pt.ogimage))
                        ...
                        objMetaFacebook.Content = weblink + "/App_Themes/VietTrung/images/logo.png";
                    ...
                    if (!string.IsNullOrEmpty(pt.metatitle))
                        this.Title = "Taobao.vn - " + pt.metatitle;
                    else
                        this.Title = "Taobao.vn - " + pt.PageTypeName;
