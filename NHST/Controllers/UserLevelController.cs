...
namespace NHST.Controllers
{
    public class UserLevelController
    {
        ...
        public static string Update(int ID, string LevelName, double FeeBuyPro, double FeeWeight, double FeeVolume, double LessDeposit, int Status, DateTime ModifiedDate, string ModifiedBy)
        {
            using (var dbe = new NHSTEntities())
            {
