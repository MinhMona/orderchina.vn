...
namespace NHST.Controllers
{
    ...
    int Status, string Description, DateTime ModifiedDate, string ModifiedBy)
        ...
        public static string UpdateWeightVolumeStatus(int ID, double Weight, double Volume, int Status, int BigPackageID, double Length, double Width,
            double Height)
        {
            using (var dbe = new NHSTEntities())
            {
        ...
        public static tbl_SmallPackage GetAllByMainOrderID(int MainOrderID, string mavandon)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_SmallPackage ps = new tbl_SmallPackage();
                ps = dbe.tbl_SmallPackage.Where(p => p.MainOrderID == MainOrderID && p.OrderTransactionCode == mavandon).SingleOrDefault();
                return ps;
            }
        }
   ...
   int Status, string Description, DateTime ModifiedDate, string ModifiedBy, int MainOrderCodeID)
        ...
        public static string InsertWithTransportationIDNew(int TransportationOrderID, int BigPackageID,
          string OrderTransactionCode, string ProductQuantity, bool IsInsurrance, string ProductType, double FeeShip, double Weight, double Volume,
          int Status, DateTime CreatedDate, string CreatedBy)
        {
            using (var dbe = new NHSTEntities())
            {
        ...
        public static tbl_SmallPackage GetByOrderTransactionCodeAndMainOrderCodeID(string OrderTransactionCode, int MainOrderCodeID)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_SmallPackage a = dbe.tbl_SmallPackage.Where(ad => ad.OrderTransactionCode == OrderTransactionCode && ad.MainOrderCodeID == MainOrderCodeID).SingleOrDefault();
                if (a != null)
                {
                    return a;
                }
        ...
        public static tbl_SmallPackage GetByOrderTransactionCodeAndMainOrderCode(string OrderTransactionCode, string MainOrderCode)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_SmallPackage a = dbe.tbl_SmallPackage.Where(ad => ad.OrderTransactionCode == OrderTransactionCode && ad.MainOrderCode == MainOrderCode).SingleOrDefault();
                if (a != null)
                {
                    return a;
                }
        ...
        public static string UpdateMainOrderCode(int ID, string MainOrderCode)
        {
            ...
            {
                var a = db.tbl_SmallPackage.Where(x => x.ID == ID).SingleOrDefault();
                if (a != null)
                {
