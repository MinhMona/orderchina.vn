...
namespace NHST.Controllers
{
    public class TransportationOrderController
    {
        ...
        #region New
        public static List<tbl_TransportationOrder> GetReportTransportBySQLNotPage(string fd, string td)
        {
            var sql = @"select * ";
        ...
        public static List<tbl_TransportationOrder> GetReportTransportBySQL(string fd, string td, int pageIndex, int pageSize)
        {
            var sql = @"select * ";
            sql += "from dbo.tbl_TransportationOrder ";
            sql += "Where ID > 0 ";
