...
namespace NHST.manager
{
    public partial class UserLeverInfo : System.Web.UI.Page
    {
        ...
        public void LoadData(int ID)
        {
            if (ID > 0)
            {
                ...
                if (level != null)
                {
                    ...
                    pFeeVolume.Value = level.FeeVolume;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            UserLevelController.Update(ID, txtLevelName.Text.Trim(), Convert.ToDouble(pFeeBuyPro.Value), Convert.ToDouble(pFeeWeight.Value), Convert.ToDouble(pFeeVolume.Value),
