    ...
    public partial class EditPage : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (news != null)
            {
                ...
                string IndexPos = txtIndexPos.Text;
                ...
                string kq = PageController.Update(NewsID, NewsTitle, NewsSummary, IMG, NewsDescription, IsHidden, Convert.ToInt32(lbChuyenMuc.SelectedValue),
                    ...
                    currentDate, Email, OGFacebookTitle.Text, OGFacebookDescription.Text, IMGFacebook, OGTwitterTitle.Text, OGTwitterDescription.Text, IMGTwitter, SideBar, IndexPos.ToInt(0));
