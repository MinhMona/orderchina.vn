                                ...
                                <div class="sort-tb-wrap">
                                    <div class="filter-link select-sort">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlSortType" onchange="SearchSort();">
                                            ...
                                            <asp:ListItem Value="1" Text="Đơn hàng cũ nhất"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Đơn hàng mới nhất"></asp:ListItem>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 l3">
                                            <asp:DropDownList runat="server" ID="ddlType">
                                                ...
                                                <asp:ListItem Value="4">Mã khách hàng</asp:ListItem>
                                            </asp:DropDownList>
                                        ...
                                        <div class="input-field col s12 l3">
                                            ...
                                            <label for="search_name"><span>Mã đơn hàng/vận đơn/tên sp/Username/Mã Kh </span></label>
                                        </div>
