...
namespace NHST.manager
{
    public partial class User_Level : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string kq = UserLevelController.Update(ID, txtLevelName.Text.Trim(), Convert.ToDouble(txtFeeBuyPro.Text), Convert.ToDouble(txtFeeWeight.Text), Convert.ToDouble(txtFeeVolume.Text),
            ...
            if (!string.IsNullOrEmpty(kq))
                ...
                PJUtils.ShowMessageBoxSwAlertBackToLink("Có lỗi khi cập nhật.", "e", true, BackLink, Page);
        }
        #region Pagging
        public void pagingall(List<tbl_UserLevel> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append("<td>" + item.FeeVolume + "</td>");
