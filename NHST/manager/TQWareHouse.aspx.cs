                            ...
                            foreach (var package in packages)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (orderTransportation != null)
                                    {
                                        ...
                                        o.OrderShopCode = "";
                                        o.Soloaisanpham = "";
                                        o.Soluongsanpham = orderTransportation.QuantityProduct;
            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    if (transportation != null)
                    {
                        ...
                        TransportationOrderNewController.UpdateWeightVolume(tID, quantity.ToString(), volume.ToString(), currentDate, username_current);
                        #endregion
