    ...
    public partial class outstock_vch_user : System.Web.UI.Page
    {
        ...
        protected void btnAllOutstock_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    PJUtils.ShowMessageBoxSwAlert("Bạn không đủ quyền thực hiện chức năng này", "e", false, Page);                   
                }
                else
                {
                    DateTime currentDate = DateTime.Now;
                    ...
                    if (acc != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(listpack))
                        {
                            ...
                            item.WareHouseFromID, item.WareHouseID, item.ShippingTypeID, true);
                                ...
                                totalPriceVND = FinalMoneyVND + feeOutStockVND + TotalSensoredFeeVND + TotalAdditionFeeVND;
                                totalPriceCYN = FinalMoneyCYN + feeOutStockCYN + TotalSensoredFeeCYN + TotalSensoredFeeCYN;
                                ...
                                string kq = ExportRequestTurnController.InsertWithUIDVolume(acc.ID, acc.Username, 0, currentDate, totalPriceVND,
                                    totalPriceCYN, totalWeight, totalVolume, note, shippingtype, currentDate, username_current, totalpackage, 1);
