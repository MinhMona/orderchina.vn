...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="card-panel">
                    ...
                    <div class="filter-wrap" style="display: block">
                        <div class="row">
                            ...
                            <div class="input-field col s12 l4">
                                <asp:TextBox runat="server" ID="search_sdt" type="text" class="validate autocomplete"></asp:TextBox>
                                <label for="search_sdt">Số điện thoại</label>
                            </div>
                            <div class="input-field col s12 l3"></div>
                            <div class="col s12 right-align">
                                <asp:Button runat="server" class="btn" ID="Button1" OnClick="btnSearch_Click" Text="Lọc kết quả"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function Delete(ID) {
            var c = confirm('Bạn muốn xóa khách hàng này?');
            if (c) {
