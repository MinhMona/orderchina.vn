                            ...
                            if (smallpackages.Count > 0)
                            {
                                foreach (var item in smallpackages)
                                {
                                    ...
                                    else if (tID > 0)
                                    {
                                        ...
                                        {
                                            d = Convert.ToDouble(item.Length);
                                        }
                                        if (item.Width.ToString().ToFloat(0) > 0)
                                        {
                                            r = Convert.ToDouble(item.Width);
                                        }
                                        if (item.Height.ToString().ToFloat(0) > 0)
                                        {
                                            c = Convert.ToDouble(item.Height);
                                        }
                                        si.dai = d;
                                        si.rong = r;
                                        si.cao = c;
            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    if (transportation != null)
                    {
                        ...
                        TransportationOrderNewController.UpdateWeightVolume(tID, quantityT.ToString(), volume.ToString(), currentDate, username_current);
