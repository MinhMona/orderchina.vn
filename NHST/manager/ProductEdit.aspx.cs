                        ...
                        if (od != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail("no-reply@mona-media.com", "demonhunter", AccountController.GetByID(Convert.ToInt32(od.UID)).Email,
                                            "Thông báo tại Taobao.vn", "Đơn hàng: " + MainOrderID + " có sản phẩm bị hết hàng.", "");
                                    }
                                    catch
                                    {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGmail("no-reply@mona-media.com",
                                                "demonhunter", AccountInfoController.GetByUserID(Convert.ToInt32(mainorder.UID)).Email,
